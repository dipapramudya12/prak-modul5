...
btn-outline-light my-2 ms-md-auto"><i class="bi-person-circle me-1"></i>
    ...
    <div class="container-sm mt-5">
        <form action="{{ route('employees.update', ['employee' => $employee->employee_id]) }}" method="POST" novalidate="">
            @csrf
            @method('PUT')
...
alert-dismissible fade show">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" type="text" name="firstName" id="firstName" value="{{ $employee->firstname }}"
                                placeholder="Enter First Name">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="lastName" class="form-label">Last
                                Name</label>
                            <input class="form-control" type="text" name="lastName" id="lastName" value="{{ $employee->lastname }}"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" type="text" name="age" id="age" value="{{ $employee->age }}"
